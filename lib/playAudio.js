...
async function preloadPages() {
    ...
    await Promise.map(Object.values(pages), page => setInterval(() => page.bringToFront(), 60000 + Math.floor(Math.random() * 9000 + 1000))); // Chromium stops buffering after ~5 minutes if a tab is inactive
    return pages;
}
